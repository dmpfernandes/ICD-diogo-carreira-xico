...
public class ObjectFactory {
    ...
    private final static QName _QuestionID_QNAME = new QName("", "questionID");
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "questionID")
    public JAXBElement<Short> createQuestionID(Short value) {
        return new JAXBElement<Short>(_QuestionID_QNAME, Short.class, null, value);
    }
